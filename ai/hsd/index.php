<?php
    ...
    $post=array(
        ...
        'txtUserName'=>'2016210201104',
        'TextBox2'=>'Syt19970811',
        'txtSecretCode'=>$res,
        'RadioButtonList1'=>'学生',
        'Button1'=>'登录',
        'lbLanguage'=>'',
    ...
    // $url = 'http://jwgl1.hznu.edu.cn/xs_main.aspx?xh=201620020214';
    // $html = get_content($result, $cookie);
    // // echo $html;

    $url5 = "http://jwgl1.hznu.edu.cn";
    ...
    echo $url;
    $content = get_content($url, $cookie, $url);
    echo $content;
